...
class Stage2HContractNoInferenceTests(unittest.TestCase):
    def test_no_target_or_timing_inference_is_authorized(self) -> None:
        ...
        self.assertFalse(contract["joined_harmonic_labels_authoritative"])
