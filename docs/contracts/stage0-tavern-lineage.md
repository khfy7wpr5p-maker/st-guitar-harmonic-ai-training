...
- The authoritative exact TAVERN work set is the Stage 0-I `DOCUMENTED_WORK_IDS` contract. Stage 0-J's catalogue-to-alias transform must match that central set exactly; a missing or additional mapping fails closed.
